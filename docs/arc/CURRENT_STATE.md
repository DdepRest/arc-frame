...
- **Текущая версия: 3.47.3** (релиз 2026-07-22: исправлено отображение 0 ₽ для Отлив/Козырёк в старых заказах).
...
- **Текущий статус тестов: 1515/1515 pass** (после стабилизации теста прогресса автообновления и добавления регрессий для signed-ввода суммы монтажа).
