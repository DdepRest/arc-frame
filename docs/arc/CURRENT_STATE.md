...
- **Текущая версия: 3.47.2** (релиз 2026-07-21: исправлены неработающие кнопки «Обновить» / «Позже» в уведомлении о новой версии — `ToastCanvas` пропускал клики насквозь из-за `IsHitTestVisible="False"` на родительском Grid).
