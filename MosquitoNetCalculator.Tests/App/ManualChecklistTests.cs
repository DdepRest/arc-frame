...
namespace MosquitoNetCalculator.Tests.App
{
    ...
    public class ManualChecklistTests : IDisposable
    {
        ...
        // ═══════════════════════════════════════════════════════════════════
        // §12. «Отправить на завод» — УДАЛЁН (v3.54): кнопка «На завод»,
        // диалог SendToFactoryWindow и сервис FactoryTextService убраны;
        // вместо них — кнопка «Шаблоны» (OrderTemplateService + TemplatesWindow).
        // Тесты §12 сняты вместе с функционалом.
    }
}
