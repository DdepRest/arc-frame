...
namespace MosquitoNetCalculator.Tests.Services
{
    public class UpdateLogTests
    {
        ...
        public void AllNewestFirst_FirstItemIsNewest()
        {
            ...
            // The latest version in the JSON is 3.40.1 (update this when bumping).
            ...
            Assert.Equal("3.40.1", items[0].Version);
        }
        ...
        {
            var changes = UpdateLog.GetChangesSince(new Version(3, 40, 1));
