...
namespace MosquitoNetCalculator.Tests.Services
{
    public class UpdateLogTests
    {
        ...
        public void AllNewestFirst_FirstItemIsNewest()
        {
            ...
            // The latest version in the JSON is 3.52.0 — update this when bumping.
            ...
            Assert.Equal("3.52.0", items[0].Version);
        }
        ...
        {
            // 3.52.0 — новейшая запись в JSON (обновлять при каждом bump).
            var changes = UpdateLog.GetChangesSince(new Version(3, 52, 0));
