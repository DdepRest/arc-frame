...
namespace MosquitoNetCalculator.Tests.Services
{
    ...
    public class UpdateLogVoiceTests
    {
        ...
        /// 3.44.0. Всё, что старше, — выпущенная история с текстом, который никто
        /// не переписывал: её не трогаем (append-only), но и это не повод ослаблять
        /// страж для новых версий.
        /// </summary>
        private static readonly Version Cutoff = new(3, 44, 0);
