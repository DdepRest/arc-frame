...
namespace MosquitoNetCalculator.Tests.Services
{
    ...
    {
        /// <summary>
        /// С какой версии действует правило. Записи старше — история (append-only
        /// контракт: их не переписываем), но это не повод ослаблять страж для новых:
        /// каждая новая версия обязана проходить проверку.
        /// </summary>
        private static readonly Version Cutoff = new(3, 53, 0);
