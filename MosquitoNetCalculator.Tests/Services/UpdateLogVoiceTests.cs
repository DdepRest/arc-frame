...
namespace MosquitoNetCalculator.Tests.Services
{
    ...
    {
        /// <summary>
        /// С какой версии действует правило: 3.50.0 — первая запись, которую
        /// пользователь увидит после установленной 3.49.0. Всё, что старше
        /// (3.49.0 и ниже), — выпущенная история: её не переписываем (append-only),
        /// но и это не повод ослаблять страж для новых версий.
        /// </summary>
        private static readonly Version Cutoff = new(3, 50, 0);
