...
namespace MosquitoNetCalculator.Tests.Services
{
    ...
    {
        /// <summary>
        /// С какой версии действует правило: 3.49.0 — самая старая запись, которую
        /// пользователь ещё видит в «Обновлениях» (её текст переписан последним).
        /// Всё, что старше (3.48.x и ниже), — выпущенная история: её не переписываем
        /// (append-only), но и это не повод ослаблять страж для новых версий.
        /// </summary>
        private static readonly Version Cutoff = new(3, 49, 0);
